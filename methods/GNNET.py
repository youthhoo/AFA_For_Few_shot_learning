...
class GNNet(nn.Module):
  def __init__(self, params):
    ...
    # optimizer
    model_params, Domain_params, Domain_ft_params, all_params = self.model_parameters()
    self.all_model_optim = torch.optim.Adam(all_params)
  ...
  def model_parameters(self):
    ...
    for n, p in self.model.named_parameters():
        ...
        # print(n)
            ...
            model_params.append(p)
    return model_params, Domain_params, Domain_ft_params, all_params
  ...
  def train_loop(self, epoch, base_loader, total_it):
    ...
    for i, (x, _) in enumerate(base_loader):
      ...
      # optimize
      self.all_model_optim.zero_grad()
